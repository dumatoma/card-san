<template>
  <div class="container" @click="riliShow = false">
    <div class="tit-box" v-if="shows == 2">
      ...
      <div class="right shou" @click="toNext">メッセージ作成</div>
    </div>
    ...
    <div class="content-box no-size" v-if="shows == 2">
      ...
      <div class="content no-size" v-for="(item, index) in list" :key="index">
        <div class="left">
          ...
          <span @click="showDetail(item.id)" class="shou ho">
            <u>{{ item.title }}</u></span
          >
        </div>
      ...
      <div class="items">
        ...
        <div class="text-box no-size" v-if="active == false">
          <div class="textare no-size" style="overflow: scroll;">
            <div>
              <div class="tt" style="margin-top: 41px">
                ここにファイルをドラッグ
              </div>
              <div class="tt">または</div>
              <el-upload
                class="el-image"
                :limit="1"
              ...
              >
                <div class="tt-bb no-size shou">+<span>ファイル選択</span></div>
              </el-upload>
            </div>
            <img :src="imageUrl" alt="" style="width: 100%;" v-if="imageUrl" />
          </div>
        </div>
      </div>
        ...
        <div class="pei-mes no-size">
          ...
          <div class="items-boxs" v-if="radio1 == 2">
            ...
            <div class="items-box">
              ...
              <div class="ip le-f">
                <div class="le-left">
                  <el-select v-model="stime" placeholder="">
                    <el-option
                ...
                <div class="le-right">
                  <el-radio-group v-model="storeTime">
            ...
            <div class="items-box">
              ...
              <div class="ip le-f">
                <div class="le-left">
                  <el-select v-model="cishu" placeholder="">
                    <el-option
                ...
                <div class="le-right">
                  <el-radio-group v-model="storeCi">
    ...
    <div class="fixed" v-show="peiShow">
      ...
      <div class="box">
        ...
        <el-button type="success" class="btn11" @click="pays">配信する</el-button>
    ...
    <div class="fixed" v-show="previewShow">
      ...
      <div class="per-box">
        ...
        <div class="preview">
          <div class="lef">
            <img src="../static/yulan-tou.png" alt="" />
          </div>
    ...
    <div class="mask" v-if="shows2 == true">
        <div class="containp" v-if="shows2 == true">
            <div class="tipContent">
                ...
                <div class="buttons">
                    <el-button type="danger" class="btn1" @click="pays">配信する</el-button>
                    <el-button type="info" class="btn2" @click="shows2 = false">キャンセル</el-button>
                </div>
            </div>
        </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    editItem(){
      ...
      that.shows = 1
      that.editShow = false
      that.$router.push("mass?new=1&id="+that.id)
    ...
    deleteItem(){
       let that = this
       deleteTimingItem(that.id).then((res) => {
           if(res.code == 200){
    ...
    keep() {
      ...
      let temp1 = []
      let temp2 = []
      let tempDate = that.formatDate(that.value1)
      let tempTime = that.formatTime(that.value2)
