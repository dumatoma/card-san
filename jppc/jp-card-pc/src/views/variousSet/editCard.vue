<template>
    <div @click="releaseShow = false">
        <div class="not_tit u-flex u-row-between">
            ...
            <div class="btn_grey shou u-flex u-row-center" @click.stop="showpreview">
                Preview
            </div>
        </div>
        <div class="not_cont no-size">
            <div v-if="query.type != 'three'">
                ...
                <div style="padding: 30px 0 0 39px">
                    <div class="cardY" :style="`background:${form.color}`" v-if="query.type == 'one'">
                        <div class="cardInner">
                            <div class="seal u-flex u-row-center" v-for="(item, index) in choice" :key="index"
                                ...
                                <div class="sealItem">
                                    ...
                                    <div v-if="!temShow && temIndex == 0" :style="`backgroundImage: url(${svgData11})`"
                                        class="icon1"></div>
                                    <div v-if="!temShow && temIndex == 1" :style="`backgroundImage: url(${svgData12})`"
                                        class="icon1"></div>
                                    <div v-if="!temShow && temIndex == 2" :style="`backgroundImage: url(${svgData13})`"
                                        class="icon1"></div>
                                    <div v-if="!temShow && temIndex == 3" :style="`backgroundImage: url(${svgData14})`"
                                        class="icon1"></div>
                                    <div v-if="!temShow && temIndex == 4" :style="`backgroundImage: url(${svgData15})`"
                                        class="icon1"></div>
                                    <div v-if="!temShow && temIndex == 5" :style="`backgroundImage: url(${svgData16})`"
                                        class="icon1"></div>
                                    <div v-if="!temShow && temIndex == 6" :style="`backgroundImage: url(${svgData17})`"
                                        class="icon1"></div>
                                    <div v-if="!temShow && temIndex == 7" :style="`backgroundImage: url(${svgData18})`"
                                        class="icon1"></div>
                                    <img :src="diyImage" v-if="temShow"
                    ...
                    <div class="cardY" :style="`background:${form.color}`" v-if="query.type == 'two'">
                        <div class="cardInner" style="height: 164px;overflow-y: auto;position: relative;">
                            <div class="sealTitle"
                                style="border-bottom: 1px solid #d2d2d7;position: sticky;top: 0;background: #fff;z-index: 67;">
                            ...
                            <div class="u-flex u-row-center seals" v-for="(item, index) in choice" :key="index"
                                style="position: relative;">
                                <!-- <div class="day">{{ index + 1 }}</div>
                <div class="sealItem">
                    <img :src="selectIcon" /> 
                    ...
                    <input type="text" class="int" placeholder="店舗名もしくはメンバーズカード名を入力" v-model="cardname" />
                    <div class="u-flex m-t-40" v-if="query.type != 'three'">
                        <div class="color-70">カードの背景色を選択</div>
                        <div
                            :style="`background:${form.color};width: 100px;height: 40px;border-radius: 6px;box-shadow: 0px 0px 6px 1px rgba(0, 0, 0, 0.16);position:relative;margin-left:15px`">
            ...
            ></colorPicker> -->
                ...
                <div style="padding: 40px 0 40px 45px" v-if="query.type != 'three'">
        ...
        filter: drop-shadow(10000px 0 0 ${form.colorTwo});`" > -->
                    ...
                    <div class="u-flex template m-t-40">
                        ...
                        <img src="@/static/index/select.png" v-else @click.stop="temClick" />
                        <div class="tem_text m-l-10" :class="[!temShow ? 'rad_black' : 'rad_grey']">
                            テンプレートから選択
                        </div>
                    </div>
                    <div class="u-flex m-t-40">
              ...
              :key="index"
               -->
                        ...
                        <div class="tem_item u-flex-col u-col-center m-r-20" @click.stop="radiuClick(0)">
                            ...
                            <div class="radius shou" :class="{ radiusCss: 0 == temIndex }" style="margin-top: 16px">
                        ...
                        <div class="tem_item u-flex-col u-col-center m-r-20" @click.stop="radiuClick(1)">
                            ...
                            <div class="radius shou" :class="{ radiusCss: 1 == temIndex }" style="margin-top: 16px">
                        ...
                        <div class="tem_item u-flex-col u-col-center m-r-20" @click.stop="radiuClick(2)">
                            ...
                            <div class="radius shou" :class="{ radiusCss: 2 == temIndex }" style="margin-top: 16px">
                        ...
                        <div class="tem_item u-flex-col u-col-center m-r-20" @click.stop="radiuClick(3)">
                            ...
                            <div class="radius shou" :class="{ radiusCss: 3 == temIndex }" style="margin-top: 16px">
                        ...
                        <div class="tem_item u-flex-col u-col-center m-r-20" @click.stop="radiuClick(4)">
                            ...
                            <div class="radius shou" :class="{ radiusCss: 4 == temIndex }" style="margin-top: 16px">
                        ...
                        <div class="tem_item u-flex-col u-col-center m-r-20" @click.stop="radiuClick(5)">
                            ...
                            <div class="radius shou" :class="{ radiusCss: 5 == temIndex }" style="margin-top: 16px">
                        ...
                        <div class="tem_item u-flex-col u-col-center m-r-20" @click.stop="radiuClick(6)">
                            ...
                            <div class="radius shou" :class="{ radiusCss: 6 == temIndex }" style="margin-top: 16px">
                        ...
                        <div class="tem_item u-flex-col u-col-center m-r-20" @click.stop="radiuClick(7)">
                            ...
                            <div class="radius shou" :class="{ radiusCss: 7 == temIndex }" style="margin-top: 16px">
                    ...
                    <div class="u-flex m-t-40">
                        ...
                        <div
                            :style="`background:${form.colorTwo};width: 100px;height: 40px;border-radius: 6px;box-shadow: 0px 0px 6px 1px rgba(0, 0, 0, 0.16);position:relative;margin-left:15px`">
                            <el-color-picker v-model="form.colorTwo" show-alpha :predefine="predefineColors"
                                style="position: absolute;left: 0;top:0;z-index: 9 !important;border: none !important;"
                                @change="colorChange">
                            </el-color-picker>
                        </div>
            ...
            ></colorPicker> -->
                    ...
                    <div class="select" style="position: relative;left: 30px;margin: 20px 0 10px;"
                        v-if="temShow && diyImage">
                    ...
                    <div class="add" style="position: relative;left: 30px;">
                        <el-upload class="upload-demo" accept="image/*" action="https://api.card-san.jp/tool/upload/file"
                            :before-upload="overfk" :on-success="handleAvatarSuccess1" :limit="1"
            ...
            <div v-else style="padding-bottom: 30px;">
                ...
                <div style="padding: 49px 0 0px 40px">
                    <div class="u-flex">
                        <div class="radius shou" style="margin-right: 16px" @click.stop="pointClick"
                    ...
                    <div class="u-flex m-l-30 m-t-20">
                        <input class="point_int" :readonly="!pointShow" type="number"
                            style="box-sizing: border-box;padding-left: 10px;" v-model="money" />円利用ごとに
                        <input class="point_int m-l-30" :readonly="!pointShow" type="number"
                            style="box-sizing: border-box;padding-left: 10px;" v-model="point" />ポイントを付与
                    </div>
                    <div class="u-flex m-t-40">
                        <div class="radius shou" style="margin-right: 16px" @click.stop="pointClick"
                            :class="{ radiusCss: !pointShow }">
            ...
            <div class="expiry">
                <div class="u-flex">
                    <div class="radius shou" style="margin-right: 16px" @click.stop="expiryClick"
                        :class="{ radiusCss: valid_type != 0 }">
                        <div class="blue_dot" v-if="valid_type != 0"></div>
                    </div>
                    <div :class="[valid_type != 0 ? 'rad_black' : 'rad_grey']">有効期限</div>
                </div>
                <div style="padding-left: 33px">
                    <div class="exp_grey">オフにすると、有効期限は設定されません</div>
                    <div class="u-flex m-t-30" v-if="valid_type != 0">
                        <div class="radius shou" :class="{ radiusCss: valid_type == 1 }" @click.stop="issueClick">
                            <div class="blue_dot" v-if="valid_type == 1"></div>
                        </div>
                        <div class="issue_date" :class="[valid_type == 1 ? 'rad_black' : 'rad_grey']">
                            カード発行日から
                        </div>
                        <el-select v-model="choiceTwo" placeholder="日数を選択" :disabled="true">
                            <el-option v-for="item in issue" :key="item.value" :label="item.label" :value="item.value">
                            </el-option>
                        </el-select>
                    </div>
                    <div class="u-flex m-t-30">
                        <div class="radius shou" @click.stop="yearClick" :class="{ radiusCss: valid_type == 2 }">
                            <div class="blue_dot" v-if="valid_type == 2"></div>
                        </div>
                        <div class="issue_date" :class="[valid_type == 2 ? 'rad_black' : 'rad_grey']">
                            年月日を指定する
                        </div>
                        <!-- 日历 -->
                        <el-date-picker v-model="value1s" type="date" size="big" format="yyyy/MM/dd"
                            value-format="yyyy/MM/dd" placeholder="日付の選択" :disabled="true">
                        </el-date-picker>
                    </div>
                </div>
            </div>
            <div class="expiry">
                <div class="u-flex">
                    <div class="radius shou" style="margin-right: 16px" @click.stop="remarksClick"
                ...
                <textarea class="tarea no-size" placeholder="備考欄への追記事項をご記入ください。" v-if="remarksShow"
                    v-model="remark"></textarea>
            </div>
            <div class="expiry">
                <div class="u-flex">
                    <div class="radius shou" style="margin-right: 16px" @click.stop="discountClick"
                    ...
                    <div class="img-bos">
                        <div class="img-boxs u-flex u-flex-wrap">
                            <div class="img-item" v-for="(item, index) in imgList" :key="index"
                                ...
                                <img src="@/static/gClose.png" alt="" class="colse shou" @click="delPicture(index)" />
                                <img :src="item" class="tu" v-if="item" @click="handlePictureCardPreview(item)" />
                                <img v-else src="@/static/index/image.png" class="moren" />
                            </div>
                        </div>
                        <el-upload class="upload-demo" accept="image/*" action="https://api.card-san.jp/tool/upload/file"
                            :on-success="handleAvatarSuccess" drag :limit="6" :show-file-list="false"
                            :file-list="fileList">
                ...
                <textarea class="tarea no-size" v-if="discountShow" placeholder="特典内容をご記入ください。"
        ...
        <div class="fixed" v-show="rectangleShow">
            ...
            <div class="per-box" v-if="!squareShow">
                <div class="tit">
                    <img class="shou" @click="rectangleShow = false" src="@/static/index/close.png" alt="" />
                ...
                <div class="cardInfo">
                    ...
                    <div class="cardInfos">
                        <div class="ciItem" v-if="valid_type != 0">
                            <div class="ciLeft">有効期限</div>
                            <div class="ciRight" v-if="yearShow">{{value1s}}</div>
                            <div class="ciRight" v-else>カード発効日から{{choiceTwo}}間</div>
                        </div>
                ...
                <div class="cardInfo">
                    ...
                    <div class="u-flex u-col-top three_bottom" v-for="(item, index) in 2" :key="index"
                        ...
                        <div class="u-flex">
                            <img src="@/static/index/record3.png" style="width: 22px; margin-right: 8px" alt="" />
                            長谷川杏
                        </div>
                    </div>
                </div>
            ...
            <div class="per-box" style="zoom: 0.9;" v-if="squareShow">
                ...
                <div class="cardInfo">
                    ...
                    <div class="cardY" :style="`background:${form.color}`" v-if="query.type == 'two'">
                        <div class="cardInner" style="height: 164px !important;overflow-y: auto;position: relative;">
                            <div class="sealTitle"
                                style="position: sticky;top: 0;background: #fff !important;z-index: 77;">
                                <div class="st1">NO</div>
                                <div class="st2">日付</div>
                                <div class="st3">
                                    <img src="../../static/corent.png" alt="">
        ...
        methods: {
            getDetail(e) {
                ...
                getCardInfo(e).then((res) => {
                    ...
                    if (res.code == 200) {
                        that.cardname = res.data.card.name
                        that.choice = res.data.card.count
                        that.form.color = res.data.card.background_color
                        that.form.colorTwo = res.data.card.seal_color
                        that.colorChange(res.data.card.seal_color)
                        that.valid_type = res.data.card.valid_type
                        that.temShow = false
                        that.remarksShow = res.data.card.is_remark == 0 ? false : true
                        that.remark = res.data.card.remark
                        that.choiceTwo = res.data.card.valid_day > 200 ? (res.data.card.valid_day / 365) + "年" :
                            res.data.card.valid_day + "日"
                        that.value1s = res.data.card.expire_time
                        that.discountShow = res.data.card.is_discount == 1 ? true : false
                        that.content = res.data.card.discount_content
                        that.imgList = res.data.card.discount_images
                        that.money = res.data.card.amount
                        that.point = res.data.card.point
                        that.pointShow = res.data.card.is_point == 1 ? true : false
                        console.log(res.data.card.seal_icon.includes('sv_05'))
                        if (res.data.card.seal_icon.includes('sv_01')) {
                            that.temIndex = 0
                        } else if (res.data.card.seal_icon.includes('sv_02')) {
                            that.temIndex = 1
                        } else if (res.data.card.seal_icon.includes('sv_03')) {
                            that.temIndex = 2
                        } else if (res.data.card.seal_icon.includes('sv_04')) {
                            that.temIndex = 3
                        } else if (res.data.card.seal_icon.includes('sv_05')) {
                            that.temIndex = 4
                        } else if (res.data.card.seal_icon.includes('sv_06')) {
                            that.temIndex = 5
                        } else if (res.data.card.seal_icon.includes('sv_07')) {
                            that.temIndex = 6
                        } else if (res.data.card.seal_icon.includes('sv_08')) {
                            that.temIndex = 7
                        } else {
                            that.temShow = true
                            that.temIndex = -1
                            that.diyImage = res.data.card.seal_icon
                        }
                    }
                })
            },
            ...
            saveCard() {
                ...
                data['seal_icon'] = that.temShow == true? that.diyImage : that.selectIcon
