<template>
    <div class="color-picker" v-if="show">
        <div ref="slider" class="sv-picker" @touchstart="setSlider($event, 'sv')" @touchmove="moveSlide($event, 'sv')">
            ...
            <div class="sv-picker-background" :style="{background: 'linear-gradient(to right, white, #ffffff00)'}">
            </div>
        ...
        <div class="alpha-slider alpha-background-image" @touchstart="setSlider($event, 'alpha')"
    ...
    export default {
        ...
        mounted() {
            ...
            setTimeout(() => {
                ...
                let uniView = uni.createSelectorQuery().in(this).select(".sv-picker");
                uniView.boundingClientRect(data => {
                    sliderInfo = data
        ...
        watch: {
            color: {
                handler(newValue) {
                    if ([4, 7, 9].includes(newValue.length)) {
                        this.selfColor = this.color;
                        setTimeout(() => {
        ...
        methods: {
            ...
            emitPickedColor() {
                ...
                this.emitTimer = setTimeout(() => {
                    ...
                    this.$emit("changeColor", this.pickedColor.hex)
                }, 100);
            },
            ...
            changeMyColor() {
                ...
                this.emitTimer = setTimeout(() => {
                    ...
                    // this.$emit("changeColor", this.selfColor)
                }, 100);
            }
        }
    }
