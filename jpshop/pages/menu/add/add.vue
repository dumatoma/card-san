<template>
    <view class="contain border_top">
        <u-navbar title="メニュー登録" :placeholder="true" :border="true" :autoBack="true" :safeAreaInsetTop="true">
        ...
        <view class="content">
            ...
            <view class="insertContent">
                ...
                <view class="insertItem">
                    ...
                    <u-input placeholder="メニュー名を入力してください" v-model="title"></u-input>
                </view>
                <view class="insertItem">
                    <view class="insertTitle">
                        メニュー説明
                    </view>
                    <u-textarea placeholder="メニュー名を入力してください" maxlength="-1" v-model="details"></u-textarea>
                </view>
                <view class="insertItem">
                    <view class="insertTitle">
                        価格
                    </view>
                    <u-input placeholder="価格を入力してください" v-model="price"></u-input>
                </view>
                <view class="sTitle">
                    <view class="titleLeft" @click="changeAppoint">
                        <view class="select" :style="appoint == false? 'border:2upx solid #d2d2d7' : '' ">
                            <view class="fill" v-if="appoint"></view>
                        </view>
                    </view>
                ...
                <view class="sTitle" style="margin-top: 44upx;" v-if="appoint">
                ...
                <view class="sTitle" style="margin-top: 20upx;"  v-if="appoint">
                    <view class="titleLeft">
                        <view class="select" style="visibility: hidden;">
                            <view class="fill"></view>
                        </view>
        ...
        <u-popup :show="showPop" mode="bottom" :round="10" @close="closePop" @cancel="closePop">
            <view class="pTitle">
                <view class="pClose">
                    <image src="../../../static/icons/tclose.png" mode=""></image>
                </view>
                <view class="tDetail">
                    メニュー
                </view>
            ...
            <view class="pContent">
                ...
                <view class="dc">
                    ...
                    <view class="dcRight" v-text="details"></view>
                </view>
            </view>
        </u-popup>
    </view>
