<template>
    <view>
        ...
        <view class="item">
            ...
            <u--input fontSize="32rpx" v-model="shopName"></u--input>
        </view>
        <view class="item">
            <view class="itemName">
        ...
        <u-popup :show="showPopup" round="32">
            ...
            <view class="preContent">
                <view class="preItem">
                    <view class="preImage">
                        <image style="width: 100%;height: 100%;" :src="image" mode=""></image>
                    </view>
...
<script>
    export default {
        ...
        onLoad(options) {
           let query = options
           query.shop_name =  decodeURIComponent(query.shop_name)
