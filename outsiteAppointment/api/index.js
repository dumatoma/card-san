...
export const menuList = (data) => {
    return request({
        url: "/api/member/menu?page="+data.page+"&page_size=50&collect="+data.collect+"&sid="+data.sid+"&is_order=1",
        method: "get"
    })
}
...
// 获取登录信息（apple）
export const getAppleInfo = (id,token) => {
    return request({
